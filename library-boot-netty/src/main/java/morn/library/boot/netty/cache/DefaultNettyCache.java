...
@Slf4j
@Objective
@CacheConfig(cacheNames = ApplicationConstants.Caches.NETTY)
public class DefaultNettyCache implements NettyCache {
  ...
  @Override
  @Cacheable(cacheNames = ApplicationConstants.Caches.NETTY_CHANNEL_ID, key = "#identify.toString()")
  ...
  @Override
  @Cacheable(cacheNames = ApplicationConstants.Caches.NETTY_GROUP, cacheManager = ApplicationConstants.Caches.CACHE_MANAGER_NAME_SIMPLE)
  public ChannelGroup getGroup(String name) {
    return new DefaultChannelGroup(name, GlobalEventExecutor.INSTANCE);
  }

  @Override
  @Cacheable(cacheNames = ApplicationConstants.Caches.NETTY_CHANNEL_IDENTIFY, key = "#channelId.asShortText()")
  ...
  @Override
  @CachePut(cacheNames = ApplicationConstants.Caches.NETTY_CHANNEL_ID, key = "#identify.toString()")
  ...
  @Override
  @CachePut(cacheNames = ApplicationConstants.Caches.NETTY_CHANNEL_IDENTIFY, key = "#channelId.asShortText()")
   ...
   */
  @Override
  @CacheEvict(cacheNames = ApplicationConstants.Caches.NETTY_CHANNEL_ID, key = "#identify.toString()")
   ...
   */
  @Override
  @CacheEvict(cacheNames = ApplicationConstants.Caches.NETTY_CHANNEL_IDENTIFY, key = "#channelId.asShortText()")

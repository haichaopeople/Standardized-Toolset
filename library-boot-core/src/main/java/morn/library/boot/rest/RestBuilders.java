...
public class RestBuilders {
  ...
  public static RestBuilder infoBuilder() {
    return builder().status(RestMessageConstants.SUCCESS).level(RestMessageLevel.INFO);
  }
  ...
  public static RestBuilder errorBuilder() {
    return builder().status(RestMessageConstants.FAILURE).level(RestMessageLevel.ERROR);
  }

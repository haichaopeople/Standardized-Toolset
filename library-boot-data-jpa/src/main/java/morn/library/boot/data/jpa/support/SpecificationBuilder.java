package morn.library.boot.data.jpa.support;
...
import morn.library.boot.data.jpa.JpaBatchCondition;
import morn.library.boot.data.jpa.JpaCommon;
import morn.library.boot.data.jpa.JpaParameter;
import morn.library.boot.data.jpa.JpaPredicate;
import morn.library.boot.data.jpa.JpaReference;

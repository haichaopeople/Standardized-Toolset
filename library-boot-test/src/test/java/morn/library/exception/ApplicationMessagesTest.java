...
public class ApplicationMessagesTest {
  ...
  public void testBuildException() {
    ...
    log.info("{}", JSON.toJSONString(applicationException));
    Assert.assertNotNull(applicationException);
    Assert.assertEquals(ApplicationMessages.FAILURE_CODE, applicationException.getCode());
...
//    Assert.assertNull(applicationException.getSolution());
  ...
  public void testBuildMessage() {
    ...
    Assert.assertEquals(ApplicationMessages.FAILURE_CODE, applicationMessage.getCode());
